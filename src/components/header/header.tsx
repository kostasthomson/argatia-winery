...
export default function Header() {
	return (
		<header className="sticky top-0 bg-transparent mb-5 w-full h-28 grid grid-cols-3 gap-2 items-center justify-items-center shadow-lg rounded-br-3xl rounded-bl-3xl">
			<BurgerMenu />
