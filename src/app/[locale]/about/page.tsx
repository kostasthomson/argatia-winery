    ...
    <>
      ...
      >
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <div className="w-16 h-px bg-[var(--color-gold)] mx-auto mt-6" aria-hidden="true" />
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 max-w-[1200px]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="fade-in">
              <h2 id="history-heading" className="text-3xl font-light mb-8" style={{ fontFamily: "Georgia, serif" }}>
                {t("history.title")}
              </h2>
            ...
            <div className="fade-in space-y-6" aria-label="Timeline">
              {[
                { year: "2000", label: t("history.founding").substring(0, 60) + "…" },
                { year: "2008", label: t("history.vineyards").substring(0, 60) + "…" },
                { year: "2025", label: t("history.secondGen").substring(0, 60) + "…" },
              ].map(({ year, label }) => (
                <div key={year} className="flex gap-6 items-start">
                  <div className="flex-shrink-0 w-16 text-right">
                    <span className="text-2xl font-light text-[var(--color-gold)]" style={{ fontFamily: "Georgia, serif" }}>
                      {year}
                    </span>
                  </div>
                  <div className="flex-shrink-0 flex flex-col items-center pt-2">
                    <div className="w-3 h-3 rounded-full bg-[var(--color-gold)]" />
                    <div className="w-px flex-1 bg-[var(--color-border)] mt-2" style={{ minHeight: "40px" }} />
                  </div>
      ...
      <section className="section-alt" aria-labelledby="argatia-heading">
        <div className="container mx-auto px-6 max-w-[1200px]">
          <div className="max-w-3xl mx-auto text-center fade-in">
            <h2 id="argatia-heading" className="section-title">{t("argatia.title")}</h2>
            <div className="w-16 h-px bg-[var(--color-gold)] mx-auto mb-8" aria-hidden="true" />
      ...
      <section className="section" aria-labelledby="philosophy-heading">
        <div className="container mx-auto px-6 max-w-[1200px]">
          <h2 id="philosophy-heading" className="section-title">{t("philosophy.title")}</h2>
      ...
      <section className="section-alt" aria-labelledby="founders-heading">
        <div className="container mx-auto px-6 max-w-[1200px]">
          <h2 id="founders-heading" className="section-title">{t("team.title")}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-3xl mx-auto mb-12">
            {founders.map(({ key, role, name, bio }) => (
              <article key={key} className="text-center fade-in">
                ...
                <p className="text-xs tracking-widest uppercase text-[var(--color-gold)] mb-1">{role}</p>
